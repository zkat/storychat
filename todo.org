...
** TODO Typing notification status things for user list                  :ui:
...
** TODO Display list of connected users                                  :ui:
** TODO Change your name in connected user list                          :ui:
** TODO Display which user is using which character                      :ui:
