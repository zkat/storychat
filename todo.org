...
** TODO Set up a basic test with testee                     :qa:architecture:
   ...
   the like.
** TODO Write unit tests for mona                                      :mona:
** TODO Extract mona into a separate project                           :mona:
...
* active [0/6]
** TODO can.route, pushState, and pages                        :pages:server:
   Set up the whole shebang that will allow use of pushState,
   can.route-based routing, and easy configuration of pages based on
   controls.
